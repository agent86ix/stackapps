...
(function () {
    ...
    Markdown.Converter = function () {
        ...
        this.makeHtml = function (text) {
			...
			// a86: put the * character back in lists, so it doesn't get caught as italics...
        ...
        function _RunSpanGamut(text) {
            ...
            // Do hard breaks:
            //a86: not required.  text = text.replace(/  +\n/g, " <br>\n");
        ...
        function writeAnchorTag(wholeMatch, m1, m2, m3, m4, m5, m6, m7) {
			...
			var result = "[url=\""+url+"\"]"+link_text+"[/url]";
        ...
        function writeImageTag(wholeMatch, m1, m2, m3, m4, m5, m6, m7) {
            ...
            url = escapeCharacters(url, "*_");
			var result = "[b]IMAGE MISSING: "+url+"[/b]";
			/*
        ...
        function _DoAutoLinks(text) {
			...
			var replacer = function (wholematch, m1) { return "[url=" + m1 + "]" + pluginHooks.plainLinkText(m1) + "[/url]"; }
